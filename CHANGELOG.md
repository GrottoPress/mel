...
### Fixed
- Improve thread-safety of `Mel::Memory`
- Make `Mel::Memory#transaction` atomic
...
- Fix hung process after PostgreSQL killed in the background
...
### Fixed
- Fix compile error with `redis` shard v0.15.1
